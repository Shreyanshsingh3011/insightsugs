 ...
 */
export function RowQualityBadge({
  issues,
  row,
  rowLabel,
}: {
  issues: RowQualityIssue[] | undefined;
  /** When provided, an inline "Auto-fix suggestions" button appears beside the badge. */
  ...
  return (
    <span className="inline-flex items-center gap-1.5 align-middle">
      ...
      {row && <RowQualityFixButton row={row} issues={issues} rowLabel={rowLabel} />}
    </span>
  );
}
